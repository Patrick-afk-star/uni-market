            ...
            <div>
              ...
              <div className="relative">
                ...
                <button
                  ...
                  className="absolute right-3 top-1/2 -translate-y-1/2 text-gray-400 hover:text-gray-600 dark:text-[#b7b1a6] dark:hover:text-gray-300 flex items-center justify-center"
                  tabIndex={-1}
                >
                  {showPassword ? (
