        ...
        <>
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center justify-between gap-2">
                        ...
                        <span className="text-xs text-[#a0a0a0] flex-shrink-0">{conv.timestamp}</span>
                      </div>
                      <p className="text-xs text-[#a0a0a0] truncate mt-0.5">{conv.itemTitle}</p>
                      <p className="text-sm text-[#a0a0a0] truncate mt-1">{conv.lastMessage}</p>
                    </div>
                    {conv.unread > 0 && (
          ...
          {selectedConversation ? (
            <div className="flex-1 flex flex-col bg-background overflow-hidden">
              {/* Chat Header */}
              <div className="h-16 px-5 border-b border-white/[0.06] flex items-center justify-between bg-[#121212] flex-shrink-0">
            ...
            <div className="flex-1 flex flex-col bg-background overflow-hidden">
              <div className="flex-1 flex items-center justify-center">
                <div className="text-center">
                  ...
                  <p className="text-sm text-[#8f8f8f]">Choose a conversation to start messaging</p>
                </div>
              </div>
            </div>
          )}
